...
| **Model Registry** | 0.3.6 | `applications/model-registry/upstream` | `./catalog-workflow.sh add-app --appname kubeflow-model-registry --version 0.3.6 --kustomize --gitrepo https://github.com/kubeflow/manifests --path ./applications/model-registry/upstream --ref master` |
